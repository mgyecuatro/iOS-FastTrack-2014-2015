...
XCPShowView("Plot 1 - Intermediate Transforms", plot1)
...
XCPShowView("Plot 2 - Composite Transform", plot2)
...
XCPShowView("Plot 3 - Composite Transform", plot3)
...
XCPShowView("Plot 4 - Orbit Transform", plot4)
